                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-slate-700 rounded-lg bg-slate-800 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
                        ...
                        <li className="relative group">
                            <Link href="/projects" className="py-2 px-3 text-slate-300 rounded-sm hover:bg-slate-700 md:hover:bg-transparent md:border-0 md:hover:text-blue-500 md:p-0 flex items-center justify-between w-full md:w-auto">
                                Projects
